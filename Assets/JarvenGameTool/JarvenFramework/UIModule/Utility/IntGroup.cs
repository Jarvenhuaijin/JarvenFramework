    ...
    public struct IntGroup : IEquatable<IntGroup>
    {
        ...
        public int this[int index]
        {
            get
            {
                ...
                if (_ints == null)
                {
                    throw new System.Exception("## Uni Exception ## Cls:IntGroup Func:this Info:Null array");
                }

                if (!_ints.TryGetValue(index, out res))
                {
                    throw new System.InvalidOperationException("## Uni Exception ## Cls:IntGroup Func:this Info:Invalid index");
        ...
        private IntGroup(params int[] args)
        {
            if (args == null)
            {
                throw new System.ArgumentNullException("## Uni Exception ## Cls:IntGroup Func:Constructor Info:Args is null");
            }
